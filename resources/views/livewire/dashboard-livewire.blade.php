                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($duration)
                                    <livewire:assignmentchart-livewire />
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="text-muted text-center mt-4 mb-2">
                            <a
                                href="
                                @if (Auth::user()->account_types->contains(1)) {{ route('ipcr.faculty') }}
                                @else
                                    {{ route('ipcr.staff') }} @endif
                            ">
