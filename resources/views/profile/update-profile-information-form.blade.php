        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="updateProfileInformation">
                ...
                <div class="form-group">
                    ...
                    <input id="account_types" type="text" class="form-control {{ $errors->has('account_types') ? 'is-invalid' : '' }}" wire:model.defer="state.account_types" autocomplete="account_types" >
